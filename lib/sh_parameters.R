...
engelska <- c("7372", "7373", "7374", "11811", "891450")
enter <- c("7375", "11843")
estetiska <- c("15801")
...
lararutbildning <- c("495", "11821", "873601", "886703", "891450")
lararinst <- c("873601", "886701", "886702", "886703", "886704")
litteraturvetenskap <- c("7457", "7458", "7459", "7460",  "11816")
maltidskunskap <- c("7473", "11838")
maris <- c("7462", "11845")
matematisk_didaktik <- c("15800", "886704")
...
nmt <- c("11831", "484", "486", "7362", "7395", "7408", "7454", "7467", "7468", "7470", "7472", "7473",
         ...
         "11838", "11839", "11840", "15800", "886700", "886705")
offent_forv <- ("884753")
...
inst_list <- list("hs" = hs, "ikl" = ikl, "nmt" = nmt, "sam" = sam,
                  "polis" = polis, "lararinst" = lararinst)
#centra: maris, scohost, cbees, ims, reinvent, politikens_org, sustainlab
centra_list <- c("enter" = enter, "maris" = maris, "scohost" = scohost, "ims" = ims, "reinvent" = reinvent,
                 "politikens_org" = politikens_org, "sustainlab" = sustainlab)
...
ämnen_list <- c("arkeologi" = arkeologi, "arkivvetenskap" = arkivvetenskap, "biologi" = biologi, "engelska" = engelska,
                ...
                "idehistoria" = idehistoria, "informatik" = informatik, "internationell_halsa" = internationell_halsa,
